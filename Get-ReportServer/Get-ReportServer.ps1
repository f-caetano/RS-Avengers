...
Try
{
Write-Host "Collecting: Report Server Configuration Files"
...
{Write-Output "Collecting: Report Server LogFiles (last $Days days)"
...
If($ConfigModeOnly -ne 1)
{Copy-Item -Path $RSInstallDir"LogFiles\*" -Include *.trc, msmdsrv.log -Destination $LogFilesDestination -Force}
