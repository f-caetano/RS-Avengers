...
Two options
1) Inside the SQL Server machine locate the files in the SQL Directory:
   usually: "<SQL Server Installation Path>\Microsoft SQL Server\MSSQLxx.MSSQLSERVER\Log\_MSFTTrace*.xel"
 
